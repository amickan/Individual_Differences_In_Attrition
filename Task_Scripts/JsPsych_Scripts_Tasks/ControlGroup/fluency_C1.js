...
if (ppn===undefined)
	ppn = 1
filename  = ppn + "_fluency_C1.dat" // audio filename, server prepends datetime
debug     = 0
waitText  = "<b>WARTE</b>"
waitTime  = 6
...
record0 = {
	type: "call-function",
	func: function(){ 
		countdown("feedback", ppn + "_fluency_C1_0")
	} ,
}
...
record1 = {
	type: "call-function",
	func: function(){ 
		countdown("feedback", ppn + "_fluency_C1_1") // server prepends datetime
	} ,
}
...
record2 = {
	type: "call-function",
	func: function(){ 
		countdown("feedback", ppn + "_fluency_C1_2")
	} ,
}
...
record3 = {
	type: "call-function",
	func: function(){ 
		countdown("feedback", ppn + "_fluency_C1_3")
	} ,
}
...
record4 = {
	type: "call-function",
	func: function(){ 
		countdown("feedback", ppn + "_fluency_C1_4")
	} ,
}
...
record5 = {
	type: "call-function",
	func: function(){ 
		countdown("feedback", ppn + "_fluency_C1_5")
	} ,
}
...
record6 = {
	type: "call-function",
	func: function(){ 
		countdown("feedback", ppn + "_fluency_C1_6")
	} ,
}
...
record7 = {
	type: "call-function",
	func: function(){ 
		countdown("feedback", ppn + "_fluency_C1_7")
	} ,
}
...
record8 = {
	type: "call-function",
	func: function(){ 
		countdown("feedback", ppn + "_fluency_C1_8")
	} ,
}
...
record9 = {
	type: "call-function",
	func: function(){ 
		countdown("feedback", ppn + "_fluency_C1_9")
	} ,
}
