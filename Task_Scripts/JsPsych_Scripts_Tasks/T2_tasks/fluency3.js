...
if (ppn===undefined)
	ppn = 1
filename  = ppn + "_fluency_T2.dat" // audio filename, server prepends datetime
debug     = 0
waitText  = "<b>WARTE</b>"
waitTime  = 6
...
record0 = {
	type: "call-function",
	func: function(){ 
		countdown("feedback", ppn + "_fluency_T2_0")
	} ,
}
...
record1 = {
	type: "call-function",
	func: function(){ 
		countdown("feedback", ppn + "_fluency_T2_1") // server prepends datetime
	} ,
}
...
record2 = {
	type: "call-function",
	func: function(){ 
		countdown("feedback", ppn + "_fluency_T2_2")
	} ,
}
...
record3 = {
	type: "call-function",
	func: function(){ 
		countdown("feedback", ppn + "_fluency_T2_3")
	} ,
}
...
record4 = {
	type: "call-function",
	func: function(){ 
		countdown("feedback", ppn + "_fluency_T2_4")
	} ,
}
...
record5 = {
	type: "call-function",
	func: function(){ 
		countdown("feedback", ppn + "_fluency_T2_5")
	} ,
}
