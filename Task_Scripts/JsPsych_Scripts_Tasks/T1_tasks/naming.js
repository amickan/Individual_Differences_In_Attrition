...
jsPsych.plugins['picture-naming'] = (function(){
    ...
    plugin.trial = function(display_element, trial){
        ...
        var uploadAudioFile = function(blob) {
            ...
            var filename = trial.ppn + "_naming_" + trial.imgIndex;
...
function saveData(data, ppn) {
    var filename  = ppn + "_naming.dat" // server adds datetime
...
var generalInstructions = {
    ...
    pages: [
        ...
        '<p>In der folgenden Aufgabe möchten wir deine Spanisch-Vokabelkenntnisse testen.</p>'+
