...
if (ppn===undefined)
	ppn = 1
filename  = ppn + "_fluency_C3.dat" // audio filename, server prepends datetime
debug     = 0
waitText  = "<b>WARTE</b>"
waitTime  = 6
...
halt_proper = {
	...
	stimulus: "Dein Mikrofon funktioniert nicht, du kannst leider nicht weiter machen.",
...
record0 = {
	type: "call-function",
	func: function(){ 
		countdown("feedback", ppn + "_fluency_C3_0")
	} ,
}

task0 = { 
	type: "html-keyboard-response",
	stimulus: "<div><img style='width:200px;' src='pics/englandflag.png'></img>" + "<br /><br />" + "<p><b>Englische Wörter</b> die mit <b>'D'</b> anfangen.<div id=feedback></div>",
	choices: jsPsych.NO_KEYS,
...
record1 = {
	type: "call-function",
	func: function(){ 
		countdown("feedback", ppn + "_fluency_C3_1") // server prepends datetime
	} ,
}

task1 = { 
	type: "html-keyboard-response",
	stimulus: "<div><img style='width:200px;' src='pics/englandflag.png'></img>" + "<br /><br />" + "<p><b>Englische Wörter</b> aus der Kategorie <b>'Körperteile'</b>.<div id=feedback></div>",
	choices: jsPsych.NO_KEYS,
	trial_duration: (waitTime+speakTime)*1000,
}
...
record2 = {
	type: "call-function",
	func: function(){ 
		countdown("feedback", ppn + "_fluency_C3_2")
	} ,
}

task2 = { 
	type: "html-keyboard-response",
	stimulus: "<div><img style='width:200px;' src='pics/englandflag.png'></img>" + "<br /><br />" + "<p><b>Englische Wörter</b> aus der Kategorie <b>'elektrische Geräte'</b>.<div id=feedback></div>",
	choices: jsPsych.NO_KEYS,
	trial_duration: (waitTime+speakTime)*1000,
}
...
record3 = {
	type: "call-function",
	func: function(){ 
		countdown("feedback", ppn + "_fluency_C3_3")
	} ,
}

task3 = { 
	type: "html-keyboard-response",
	stimulus: "<div><img style='width:200px;' src='pics/germanyflag.png'></img>" + "<br /><br />" + "<p><b>Deutsche Wörter</b> mit dem Buchstaben <b>'B'</b>.<div id=feedback></div>",
	choices: jsPsych.NO_KEYS,
	trial_duration: (waitTime+speakTime)*1000,
}
...
record4 = {
	type: "call-function",
	func: function(){ 
		countdown("feedback", ppn + "_fluency_C3_4")
	} ,
}

task4 = { 
	type: "html-keyboard-response",
	stimulus: "<div><img style='width:200px;' src='pics/germanyflag.png'></img>" + "<br /><br />" + "<p><b>Deutsche Wörter</b> aus der Kategorie <b>'Sportarten'</b>.<div id=feedback></div>",
	choices: jsPsych.NO_KEYS,
	trial_duration: (waitTime+speakTime)*1000,
}
...
record5 = {
	type: "call-function",
	func: function(){ 
		countdown("feedback", ppn + "_fluency_C3_5")
	} ,
}

task5 = { 
	type: "html-keyboard-response",
	stimulus: "<div><img style='width:200px;' src='pics/germanyflag.png'></img>" + "<br /><br />" + "<p><b>Deutsche Wörter</b> aus der Kategorie <b>'Büroartikel'</b>.<div id=feedback></div>",
	choices: jsPsych.NO_KEYS,
	trial_duration: (waitTime+speakTime)*1000,
}
...
record6 = {
	type: "call-function",
	func: function(){ 
		countdown("feedback", ppn + "_fluency_C3_6")
	} ,
}
...
record7 = {
	type: "call-function",
	func: function(){ 
		countdown("feedback", ppn + "_fluency_C3_7")
	} ,
}
...
record8 = {
	type: "call-function",
	func: function(){ 
		countdown("feedback", ppn + "_fluency_C3_8")
	} ,
}
...
record9 = {
	type: "call-function",
	func: function(){ 
		countdown("feedback", ppn + "_fluency_C3_9")
	} ,
}
